...
export const Content = () => (
  <>
    <ContentSection title="Um Fyrirtækið">
      <p>
        Teknik er fyrirtæki sem samanstendur af sérfræðingum með áratuga reynslu
        á sviði ráðgjafar, hönnunar, verkefnastjórnunar og eftirliti. Lögð er
        áhersla á góða þjónustu við viðskiptavini og virðisaukandi ráðgjöf.
      </p>
      <p>
    ...
    <div className={`verticalSpacing ${styles.cardsContainer}`}>
      <ContentCard title="Loftræsing">
        <p>
      ...
      <ContentCard title="Hönnunarstjórn og verkeftirlit">
        <p>
